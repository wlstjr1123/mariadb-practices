...
where a.emp_no = b.emp_no			-- join condition (n - 1)
...
-- 실습문제1
-- 현재 회사 상황을 반영한 직원별 근무부거를 사번, 이름, 근무 부서로 출력해보세요.
...
-- 예제 > 헌재 직책별로 평균 연봉과 인원수를 구하되 직책별로 인원이 100명 이상인 직책만 출력하세요.
...
-- 예제6: 현재 부서별로 현재 직책이 Engineer인 직우너들에 대해서만 평균급여를 구하세요.
